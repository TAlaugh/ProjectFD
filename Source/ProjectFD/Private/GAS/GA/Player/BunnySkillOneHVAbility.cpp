...
#include "GAS/GA/Player/BunnySkillOneHVAbility.h"
...
UBunnySkillOneHVAbility::UBunnySkillOneHVAbility()
{
...
bool UBunnySkillOneHVAbility::CanActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UBunnySkillOneHVAbility::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
                                            ...
                                            const FGameplayEventData* TriggerEventData)
{
	...
	if (HasAuthorityOrPredictionKey(ActorInfo, &ActivationInfo))
	{
		...
		PlaySkillMontageTask->OnBlendOut.AddDynamic(this, &UBunnySkillOneHVAbility::K2_EndAbility);
		PlaySkillMontageTask->OnCompleted.AddDynamic(this, &UBunnySkillOneHVAbility::K2_EndAbility);
		PlaySkillMontageTask->OnInterrupted.AddDynamic(this, &UBunnySkillOneHVAbility::K2_EndAbility);
		PlaySkillMontageTask->OnCancelled.AddDynamic(this, &UBunnySkillOneHVAbility::K2_EndAbility);
		...
		WaitSkillEventTask->EventReceived.AddDynamic(this, &UBunnySkillOneHVAbility::StartTargetSweep);
		WaitSkillEventTask->ReadyForActivation();
	}	
}

void UBunnySkillOneHVAbility::StartTargetSweep(FGameplayEventData EventData)
{
